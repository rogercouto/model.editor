...
public class Column extends Element implements Cloneable{
	...
	private boolean migrateValue = false;
	...
	public Column clone(){
		...
		column.setDbType(getDbType());
		column.setDefaultValue(isDefaultValue());
		column.setMigrateValue(isMigrateValue());
		return column;
	}
	
	public boolean isMigrateValue() {
		if (isSurrogateKey())
			return false;
		return migrateValue;
	}
	
	public void setMigrateValue(boolean migrateValue) {
		this.migrateValue = migrateValue;
	}

	public String getFieldName() {
		return getNormalizatedName(false);
	}
