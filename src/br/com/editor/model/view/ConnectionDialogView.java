...
public class ConnectionDialogView extends Dialog {
	 ...
	 * @param style
	 */
	public ConnectionDialogView(Shell parent) {
	...
	private void createContents() {
		...
		GridData gd_cmbDriver = new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1);
		gd_cmbDriver.widthHint = 200;
		cmbDriver.setLayoutData(gd_cmbDriver);
		...
		lblTest.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 4, 1));
