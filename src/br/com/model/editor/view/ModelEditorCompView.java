...
public class ModelEditorCompView extends Composite {
	...
	public ModelEditorCompView(Composite parent, int style) {
		...
		btnRedo = new ToolItem(toolBar, SWT.NONE);
		btnRedo.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				dobtnRedowidgetSelected(e);
			}
		});
		btnRedo.setText("Redo");
		btnRedo.setImage(SWTResourceManager.getImage(ModelEditorCompView.class, "/icon/redo16.png"));
